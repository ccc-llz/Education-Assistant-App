...
def chat_with_llm(user_id, user_input):
    ...
    #Add the newuser input to the conversation history
    prompt = "You are a intelligent and helpful study assistant. Please provide concise and informative responses."
